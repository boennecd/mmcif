...
#> 1 one thread      54.1ms   54.8ms      18.1        0B    0.251
#> 2 two threads     28.8ms   29.2ms      33.7        0B    0    
#> 3 three threads   19.9ms   20.5ms      48.7        0B    0    
#> 4 four threads    15.8ms   16.2ms      60.7        0B    0
...
#>   expression         min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>    <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 one thread       159ms  162.2ms      6.16      336B        0
#> 2 two threads     86.3ms     89ms     11.3       336B        0
#> 3 three threads   58.9ms   59.8ms     16.7       336B        0
#> 4 four threads    47.2ms   48.9ms     20.2       336B        0
```
...
#> Estimate AGHQ       -2.7612653     -3.6361658     -6.5360919     -4.9825472
#> Standard errors      0.1115511      0.1320472      0.2122189      0.1573129
#> Truth               -2.8546006     -3.5847914     -6.5119295     -4.9573949
#>                 cause1:traject:(Intercept) cause1:traject:a cause1:traject:b
#> Estimate AGHQ                    2.7889557       0.78978436       0.32070402
#> Standard errors                  0.1048409       0.05136435       0.06088643
#> Truth                            2.8655410       0.80000000       0.40000000
#>                 cause2:spline1 cause2:spline2 cause2:spline3 cause2:spline4
#> Estimate AGHQ       -2.8898834     -3.3092236     -6.2132723     -4.8800326
#> Standard errors      0.2251655      0.2292161      0.4479185      0.3180172
#> Truth               -2.5969205     -3.3415994     -6.0232223     -4.6611059
#>                 cause2:traject:(Intercept) cause2:traject:a cause2:traject:b
#> Estimate AGHQ                    3.3640785        0.2469017       -0.3477308
#> Standard errors                  0.2575477        0.0695524        0.1059213
#> Truth                            3.1144598        0.2500000       -0.2000000
...
#> Estimate AGHQ           -0.09098963           0.2771797             -0.2537332
#> Standard errors          0.14515039           0.1154924              0.1064636
#> Truth                   -0.24947003           0.2922878             -0.2485168
#>                 vcov:risk1:traject2 vcov:risk2:traject2 vcov:traject1:traject2
#> Estimate AGHQ             0.2577386          -0.4945974             -0.1056186
#> Standard errors           0.2403597           0.2011015              0.1503139
#> Truth                     0.3561275          -0.2929106             -0.1853214
...
rbind(`Estimate AGHQ` = fit$par[comp_obj$indices$coef_trajectory],
      ...
      Truth = truth[comp_obj$indices$coef_trajectory])
#>                 cause1:spline1 cause1:spline2 cause1:spline3 cause1:spline4
#> Estimate AGHQ        -2.982989     -3.6259795     -6.6762599     -4.7860112
#> Standard errors       0.164094      0.1649436      0.3373203      0.2230601
#> Truth                -3.051344     -3.6657486     -6.6720198     -4.8559792
#>                 cause1:traject:(Intercept) cause1:traject:a cause1:traject:b
#> Estimate AGHQ                     2.596630       0.88394510        0.4017035
#> Standard errors                   0.150313       0.06574697        0.0749846
#> Truth                             2.677752       0.80000000        0.4000000
#>                 cause2:spline1 cause2:spline2 cause2:spline3 cause2:spline4
#> Estimate AGHQ       -2.6792464     -3.1392296     -5.6456602     -4.1521398
#> Standard errors      0.2104229      0.1883607      0.4000963      0.2553798
#> Truth               -2.7771001     -3.3481062     -6.2334375     -4.6449539
#>                 cause2:traject:(Intercept) cause2:traject:a cause2:traject:b
#> Estimate AGHQ                    2.7000388        0.2451663       -0.1692536
#> Standard errors                  0.2252095        0.0647662        0.1199285
#> Truth                            3.0259114        0.2500000       -0.2000000
...
#> Truth                 -0.5920851       0.01446203       -0.1380145
#>                 vcov:risk1:traject1 vcov:risk2:traject1 vcov:traject1:traject1
#> Estimate AGHQ            -0.1236503           0.7068111             -0.7895923
#> Standard errors           0.1949164           0.1901756              0.5918002
#> Truth                    -0.2494700           0.2922878             -0.2485168
#>                 vcov:risk1:traject2 vcov:risk2:traject2 vcov:traject1:traject2
#> Estimate AGHQ             0.2308912          -0.1133134             -0.6814123
#> Standard errors           0.2204120           0.3098811              0.1525855
#> Truth                     0.3561275          -0.2929106             -0.1853214
#>                 vcov:traject2:traject2
