...
log Cholesky decomposition and an estimation function). 
...
the entry time as being the maximum of this variable and the zero.
...
```{r delayed_compare_estimated_incidence_funcs, fig.height=knitr::opts_chunk$get("fig.width") * .5}
local({
  # get the estimates
  coef_risk_est <- fit$par[comp_obj$indices$coef_risk] |> 
    matrix(ncol = n_causes)
