...
mmcif_data_holder <- function(covs_trajectory, d_covs_trajectory, covs_risk, has_finite_trajectory_prob, cause, n_causes, pair_indices, singletons, covs_trajectory_delayed) {
    .Call(`_mmcif_mmcif_data_holder_to_R`, covs_trajectory, d_covs_trajectory, covs_risk, has_finite_trajectory_prob, cause, n_causes, pair_indices, singletons, covs_trajectory_delayed)
}
...
mmcif_logLik_grad <- function(data_ptr, par, ghq_data, n_threads) {
